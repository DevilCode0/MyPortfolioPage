    ...
    <>
      <div className="h-screen flex items-center">
          ...
          <div className="text-white p-12 rounded-lg w-5/6">
            ...
            <div className="flex pt-11">
              <a href="https://www.linkedin.com/in/saad-alkathiri/">
                <svg
                  className="fill-slate-50 hover:fill-slate-400 hover:scale-110 hover:border-white transition-transform duration-3000 ease-in-out"
                  width="40px"
                  height="40px"
                  viewBox="0 0 16 16"
        ...
        <div className="xl:w-1/2 md:w-full justify-center flex phone:max-md:hidden">
          <div className="bg-slate-300 p-12 rounded-lg w-50">test</div>
        </div>
      </div>
      ...
      <div className="p-6 bg-gray-950">
        ...
        <p className="p-32">
          software engineer with a strong foundation in computer programming and
          experience in web development, devops, and docker containerization.
          Seeking an opportunity to contribute my technical expertise and
          passion for software production. Committed to delivering high-quality
          solutions and continuously expanding my knowledge in the ever-evolving
